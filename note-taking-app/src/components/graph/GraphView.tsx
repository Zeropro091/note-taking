    ...
    `}>
      ...
      <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
        ...
        <Button
          ...
          aria-label={isIsolated ? "Show all notes" : "Isolate node"}
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-zinc-900 border-b border-zinc-700">
              ...
              <button
                ...
                className="text-zinc-500 hover:text-zinc-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-1"
