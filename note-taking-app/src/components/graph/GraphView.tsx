...
export default function GraphView({
  ...
  // Memoize expensive derived state to prevent redundant calculations on re-renders (e.g. hover events)
  const currentData: FGData = useMemo(() => {
    // Precompute a Set of node IDs that match the filter tag to optimize edge filtering
    // Reduces O(N*E) lookup inside filter to O(N+E)
