...
export default function GraphView({
  ...
  // - Wrapped in useMemo to prevent recalculating on every re-render (e.g. mouse hover).
  // - Precomputed a Set of validNodeIds for O(1) lookups during edge filtering.
  // - Reduces edge processing time complexity from O(N*E) to O(N+E).
  // - Expected impact: Significant reduction in re-render time, preventing UI stuttering on large graphs during interactions.
