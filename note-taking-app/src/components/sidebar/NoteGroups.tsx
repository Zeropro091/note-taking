      ...
      <div className="flex-1 overflow-y-auto py-2">
        {groupedNotes.length === 0 ? (
          ...
          groupedNotes.map((group) => {
            ...
            const groupId = `group-${group.name.replace(/\s+/g, "-")}`;
              ...
              <div key={group.name} className="mb-1">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    "hover:bg-zinc-800 rounded mx-1 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-500",
                  )}
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              "hover:bg-zinc-800 rounded mx-1 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset focus-visible:ring-blue-400",
