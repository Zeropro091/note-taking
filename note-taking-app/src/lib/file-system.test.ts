...
describe("validateNoteId", () => {
  ...
  it("should completely reject any path traversal attempts even if they resolve within the directory", () => {
    // 'folder/../../note' contains '..' and should be immediately rejected
