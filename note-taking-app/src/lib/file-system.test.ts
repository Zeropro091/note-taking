...
describe('validateNoteId', () => {
  ...
  it('should reject path traversal attempts completely instead of allowing them after stripping', () => {
    // 'folder/../../note' contains a strict traversal attempt and should be explicitly rejected
