...
describe('validateNoteId', () => {
  ...
  it('should explicitly reject path traversal attempts even if they would resolve within the directory', () => {
    // We explicitly reject traversal dots as a defense in depth
