...
describe('validateNoteId', () => {
  ...
  it('should reject path traversal attempts that attempt to resolve within the directory', () => {
    // We should be strict and reject any path traversal attempts,
    // even if they appear to resolve back into the directory.
