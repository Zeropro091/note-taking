...
describe('validateNoteId', () => {
  ...
  it('should explicitly reject path traversal attempts even if they resolve within the directory', () => {
    // 'folder/../../note' contains '..' and should be rejected for defense-in-depth
