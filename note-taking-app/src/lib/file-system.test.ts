...
describe('validateNoteId', () => {
  ...
  it('should reject path traversal attempts that resolve within the directory using path traversal syntax', () => {
    // 'folder/../../note' shouldn't be allowed as validateNoteId shouldn't normalize relative traversals
