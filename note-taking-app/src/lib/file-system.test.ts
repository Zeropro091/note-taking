...
describe('validateNoteId', () => {
  ...
  it('should explicitly reject path traversal attempts even if they resolve within the directory after stripping', () => {
    // 'folder/../../note' contains '..' which should be strictly rejected for defense in depth
