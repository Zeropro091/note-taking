...
describe('validateNoteId', () => {
  ...
  it('should reject path traversal attempts that escape the base directory before stripping', () => {
    // 'folder/../../note' correctly resolves to '../note' which escapes the base directory
