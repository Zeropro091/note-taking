...
describe('validateNoteId', () => {
  ...
  it('should reject path traversal attempts even if they resolve within the directory after stripping', () => {
    // 'folder/../../note' is rejected due to defense-in-depth regex
