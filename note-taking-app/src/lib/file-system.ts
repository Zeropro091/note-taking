...
export function validateNoteId(id: string): boolean {
  ...
  // Normalize backslashes to forward slashes before resolution to prevent POSIX traversal bypasses
  const normalizedId = id.replace(/\\/g, "/");

  // Explicitly reject any IDs containing '..' as a defense-in-depth measure
