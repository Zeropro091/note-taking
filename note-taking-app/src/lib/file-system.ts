...
export function validateNoteId(id: string): boolean {
  ...
  // Prevent traversal by normalizing backslashes to forward slashes BEFORE resolving
  const normalizedId = id.replace(/\\/g, '/');

  // Explicitly reject any ID containing '..' as an extra defense-in-depth measure
