...
export function validateNoteId(id: string): boolean {
  ...
  // Normalize backslashes to forward slashes before resolving to prevent POSIX traversal bypass
  const normalizedId = id.replace(/\\/g, '/');

  // Explicitly reject '..' traversal attempts while allowing valid consecutive dots (e.g., 'my..note')
