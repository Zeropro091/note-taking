...
export function validateNoteId(id: string): boolean {
  ...
  // This prevents POSIX traversal bypasses where a path like "foo\..\..\etc\passwd"
  // is treated as a valid single filename on POSIX systems but evaluates to a
  // path traversal when sanitized and used.
